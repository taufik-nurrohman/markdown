...
Some of these need to be implemented at the data structure level, which is very specific to my parser. Others need to be
implemented after the HTML string is constructed. This one can actually be applied to any HTML string, not only the HTML
string generated by my Markdown parser. I will call those the “naive” tweaks.
